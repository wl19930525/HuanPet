package com.huanpet.huanpet.overlay;
...
public class BusLineOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        startBit = BitmapDescriptorFactory.fromResource(R.mipmap.amap_start);
        return startBit;
    }

    protected BitmapDescriptor getEndBitmapDescriptor() {
        endBit = BitmapDescriptorFactory.fromResource(R.mipmap.amap_end);
        return endBit;
    }

    protected BitmapDescriptor getBusBitmapDescriptor() {
        busBit = BitmapDescriptorFactory.fromResource(R.mipmap.amap_bus);
        return busBit;
    }
